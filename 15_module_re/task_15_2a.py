...
r_res = parse_sh_ip_int_br('sh_ip_int_br.txt')

def convert_to_dict(h_list, pars_res):
    results = []
    for int_list in pars_res:
        r_dict = dict(zip(h_list, int_list))
        results.append(r_dict)
    return results

print(convert_to_dict(headers,r_res))
